<aside
    class="group/sidebar flex flex-col shrink-0 lg:w-[280px] w-[250px] transition-all duration-300 ease-in-out m-0 fixed z-10 inset-y-0 left-0 bg-white border-r border-r-dashed border-r-neutral-200 sidenav fixed-start loopple-fixed-start"
    id="sidenav-main">
    ...
    <div class="flex items-center justify-between pl-8 pr-4 py-4">
        ...
        <a class="inline-flex ml-auto relative items-center group justify-end text-base font-medium leading-normal text-center align-middle cursor-pointer rounded-[.95rem] transition-colors duration-150 ease-in-out text-dark bg-transparent shadow-none border-0"
            href="javascript:void(0)">
            <button
                class="btn btn-ghost btn-circle leading-none transition-colors duration-200 ease-in-out peer shrink-0 group-hover:text-primary text-secondary-dark">
